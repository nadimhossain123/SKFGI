<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="LeaveReportBalance.aspx.cs" Inherits="CollegeERP.HR.LeaveReportBalance" Title="Leave Balance Report" %>
                    ...
                    <asp:Panel ID="PNLGrid" runat="server" ScrollBars="Both" Width="1000px" Height="400px">
                        <asp:GridView ID="dgvReport" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CL" HeaderText="CL TAKEN" />
                                <asp:BoundField DataField="CLBAL" HeaderText="CL BALANCE" />
                                <asp:BoundField DataField="CL_DATE" HeaderText="CL Dates" ItemStyle-Wrap="true" />
                                <asp:BoundField DataField="ML" HeaderText="ML TAKEN" />
                                <asp:BoundField DataField="MLBAL" HeaderText="ML BALANCE" />
                                <asp:BoundField DataField="ML_DATE" HeaderText="ML Dates" ItemStyle-Wrap="true" />
                                <asp:BoundField DataField="EL" HeaderText="EL TAKEN" />
                                <asp:BoundField DataField="ELBAL" HeaderText="EL BALANCE" />
                                <asp:BoundField DataField="EL_DATE" HeaderText="EL Dates" ItemStyle-Wrap="true" />
                                <asp:BoundField DataField="OTHER" HeaderText="OTHER TAKEN" />

<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="StudentSectionMapping.aspx.cs" Inherits="CollegeERP.Student.StudentSectionMapping" Title="Student Section Mapping" %>
            ...
            <div style="width: 780px">
                ...
                <table width="100%" align="center" class="table">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="ddlSection" runat="server" CssClass="dropdownList" Width="130px" DataValueField="id" DataTextField="section_name">
                            </asp:DropDownList>
                        </td>
                        <td align="right">
                            <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Mapping Now" OnClientClick="return Validation()"

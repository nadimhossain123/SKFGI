<%@ Page Title="City Master" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" 
CodeBehind="CityMaster.aspx.cs" Inherits="CollegeERP.Common.CityMaster" %>
...
<script type="text/javascript">
    function Validation() {
        ...
        if (!checkforvaliddata(eval('document.forms[0].' + '<%=txtCity.ClientID%>'), "City Name", 1)) return false;
    ...
    <div style="width: 750px;">
        ...
        <table align="center" width="100%" class="table">
            ...
            <tr>
                ...
                <td align="left" width="30%">
                    <asp:TextBox ID="txtCity" runat="server" CssClass="textbox_required" Width="140px"
        ...
        <table width="100%" align="center" class="table">
            <tr>
                ...
                <td align="left" width="25%">
                    <asp:TextBox ID="txtCitysearch" runat="server" CssClass="textbox" Width="140px"
                        MaxLength="99"></asp:TextBox>
                </td>
                 <td align="left" width="10%" class="label">
                    State 
            ...
            <tr>
                <td align="center" colspan="7">
                    <asp:GridView ID="dgvState" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                        Width="100%" DataKeyNames="CityID" PageSize="15" OnPageIndexChanging="dgvState_PageIndexChanging"

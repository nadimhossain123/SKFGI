<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BranchMaster.aspx.cs" Inherits="CollegeERP.Common.BranchMaster" Title="Branch Details" %>
        ...
        <center>
            <div style="width:580px;">
                     <table width="90%" align="center" style="padding:4px; background-color:#fff;">
                            <tr>
                                <td width="15%" align="left" class="label">Branch<span class="req">*</span></td>
                                <td width="40%" align="left">
                                    <asp:TextBox ID="txtBranch" runat="server" CssClass="textbox_required" Width="200px"></asp:TextBox>
                                </td>
                        ...
                        <table width="100%" align="center">
                            <tr>
                                <td align="center">
                                    <asp:GridView ID="dgvBranch" runat="server" AutoGenerateColumns="false" 
                                        Width="100%" AllowPaging="false"
                                        DataKeyNames="BranchId" onrowdeleting="dgvBranch_RowDeleting" 
                                        onrowediting="dgvBranch_RowEditing">
                                    <Columns>

<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="RPTJournalRegister.aspx.cs" Inherits="CollegeERP.Accounts.RPTJournalRegister"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="95%" align="center" class="table">
        <tr>
            <td align="center">
                <asp:GridView ID="gvJVDetails" runat="server" AutoGenerateColumns="False" AllowPaging="false"
                    Width="100%">
                    <Columns>
                        <asp:BoundField DataField="JVoucherDate" HeaderText="Date" />
                        <asp:BoundField DataField="JVoucherNo" HeaderText="Voucher No" HtmlEncode="false" />
                        <asp:BoundField DataField="Particulars" HeaderText="Particulars" />
                        <asp:BoundField DataField="AmountDr" HeaderText="Amount(Dr.)" ItemStyle-HorizontalAlign="Right"
                            DataFormatString="{0:n}" />
                        <asp:BoundField DataField="AmountCr" HeaderText="Amount(Cr.)" ItemStyle-HorizontalAlign="Right"
                            DataFormatString="{0:n}" />
                    </Columns>

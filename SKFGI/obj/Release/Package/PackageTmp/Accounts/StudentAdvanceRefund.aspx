<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="StudentAdvanceRefund.aspx.cs" Inherits="CollegeERP.Accounts.StudentAdvanceRefund"
    Title="Student Advance Refund" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function CheckAmount(Obj)
    {
       ...
       var Advance=row.cells[1].innerHTML;
        
       var Amount=(Obj.value == '') ? '0' : Obj.value;     
       if (parseFloat(Amount) > parseFloat(Advance))
        {
          alert("Amout Should Not Be More Than Advance");
          Obj.focus();
        }     
        TotalAmount();       
     }
    ...
    function TotalAmount()
    {
        ...
        for (rowIdx; rowIdx <= rCount-1; rowIdx ++)
        {
          ...
          var txtBox=rowElement.cells[2].getElementsByTagName("input")[0];
        ...
        <ContentTemplate>
            ...
            <table width="97%" align="center" class="table">
                <tr>
                    ...
                    <td align="left">
                        <asp:Button ID="btnSearch" runat="server" CssClass="button" Text="Get Advance List"

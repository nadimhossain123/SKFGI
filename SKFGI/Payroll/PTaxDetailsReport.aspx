<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="PTaxDetailsReport.aspx.cs" Inherits="CollegeERP.Payroll.PTaxDetailsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="100%" Height="550px" ScrollBars="Auto">

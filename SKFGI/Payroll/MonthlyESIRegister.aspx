<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="MonthlyESIRegister.aspx.cs" Inherits="CollegeERP.Payroll.MonthlyESIRegister"
    Title="Monthly ESI Register" %>
                ...
                <td align="center">
                    <asp:GridView ID="dgvReport" runat="server" Width="100%" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DOJ" HeaderText="DOJ" DataFormatString="{0:dd-MMM-yyyy}" />
                            <asp:BoundField DataField="ESINo" HeaderText="ESIC No" />
                            <asp:BoundField DataField="EmployeeSalaryDataGrossSalary" HeaderText="Gross Salary"
                                DataFormatString="{0:F0}" ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="EmployeeESI" HeaderText="Employees Contribution" DataFormatString="{0:F0}"
                                ItemStyle-HorizontalAlign="Right" />
                            <asp:BoundField DataField="EmployerESI" HeaderText="Employers Contribution" DataFormatString="{0:F0}"
                                ItemStyle-HorizontalAlign="Right" />

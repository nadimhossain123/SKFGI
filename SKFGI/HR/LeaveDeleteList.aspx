<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="LeaveDeleteList.aspx.cs" 
Inherits="CollegeERP.HR.LeaveDeleteList" Title="Leave Delete List" %>
...
<asp:UpdatePanel ID="UP1" runat="server">
    <ContentTemplate> 
    <div><uc3:Message ID="Message" runat="server" />     
                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="dgvLeave" runat="server" AutoGenerateColumns="false" 
                                 ...
                                 DataKeyNames="LeaveId,EmployeeId,LeaveTypeId" onpageindexchanging="dgvLeave_PageIndexChanging" 
                                onrowdatabound="dgvLeave_RowDataBound" onrowcommand="dgvLeave_RowCommand" >
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldays" runat="server" Text='<%# Eval("NoOfDays") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/Images/delete_icon.gif" CommandName="Del"

<%@ Page Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="StudentFeesCollection.aspx.cs" Inherits="CollegeERP.Accounts.StudentFeesCollection"
...
//        $('#<%= ddlBatch.ClientID %>').click(function(e) {      
//        alert($("#<%= ddlBatch.ClientID %>").val());
//        });
//    });

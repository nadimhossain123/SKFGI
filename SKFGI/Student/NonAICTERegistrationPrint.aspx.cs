...
{
    public partial class NonAICTERegistrationPrint : System.Web.UI.Page
    {
            ...
            if (dataTable != null && dataTable.Rows.Count > 0)
            {
                for (int i = 0; i < dataTable.Rows.Count; i++)
                {
                    if (dataTable.Rows[i]["exam_id"].ToString() == "1")
                    {
                        ...
                        lblXTotalMrkObtn.Text = dataTable.Rows[i]["total_M_Obtn"].ToString();
                    ...
                    else if (dataTable.Rows[i]["exam_id"].ToString() == "2")
                    {
                        ...
                        lblXiiTotalMrkObtn.Text = dataTable.Rows[i]["total_M_Obtn"].ToString();
                    ...
                    else if (dataTable.Rows[i]["exam_id"].ToString() == "3")
                    {
                        ...
                        lblDTotalMrkObtn.Text = dataTable.Rows[i]["total_M_Obtn"].ToString();
                    ...
                    else if (dataTable.Rows[i]["exam_id"].ToString() == "4")
                    {
                        ...
                        lblGTotalMrkObtn.Text = dataTable.Rows[i]["total_M_Obtn"].ToString();
        ...
        private void StreamName(string cast)
        {
            ...
            {
                case "BBA":
                    lblStreamApplied.Text = "BBA(Bachelor of Business Administration)";
                    break;
                case "BCA":
                    lblStreamApplied.Text = "BCA(Bachelor of Computer Application)";
                    break;
                case "BBA-HM":
                    lblStreamApplied.Text = "BBAHM(Bachelor of Business Administration)";
                    break;
                case "B.OPTM":
                    lblStreamApplied.Text = "BOPTM(Bachelor of Optometry)";
                    break;
                case "BMS":
                    lblStreamApplied.Text = "BMS(Phermaceutical Management)";
                    break;
                case "BSC-CS":
                    lblStreamApplied.Text = "B.Sc in Cyber Security";
                    break;
                case "BMLT":
                    lblStreamApplied.Text = "B.Sc in Medical Lab Technology";
                    break;
                case "BSC-HHA":
                    lblStreamApplied.Text = "B.Sc HOSPITALITY & HOTEL ADMINISTRATION";
                    break;
                case "BSC-MAG":
                    lblStreamApplied.Text = "B.Sc MULTIMEDIA,ANIMATION & GRAPHICS";
                    break;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignationMaster.aspx.cs" Inherits="CollegeERP.Common.DesignationMaster" Title="Designation Details" %>
        ...
        <center>
            <div style="width:580px;">
                     <table width="90%" align="center" style="padding:4px; background-color:#fff;">
                            <tr>
                                <td width="15%" align="left" class="label">Designation<span class="req">*</span></td>
                                <td width="40%" align="left">
                                    <asp:TextBox ID="txtDesignation" runat="server" CssClass="textbox_required" Width="200px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:GridView ID="dgvDesignation" runat="server" AutoGenerateColumns="false" 
                                        ...
                                        DataKeyNames="DesignationId" onrowdeleting="dgvDesignation_RowDeleting" 
                                        onrowediting="dgvDesignation_RowEditing">
                                    <Columns>

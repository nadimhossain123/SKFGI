...
namespace Entity.Student
{
    public class BTechRegistration
    {
        ...
        public string strEce { get; set; }
        public string strEe { get; set; }
        public string strCse { get; set; }
        public string strAeie { get; set; }
        public string strMe { get; set; }
        public string strCe { get; set; }
        public string strPhy { get; set; }
        public string strChem { get; set; }
        public string strMath { get; set; }
        public string strEngg { get; set; }
        public string strBios { get; set; }

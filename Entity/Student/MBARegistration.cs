...
namespace Entity.Student
{
    public class MBARegistration
    {
        ...
        public string strNameofComapny1 { get; set; }
        public string strResponsibility1 { get; set; }
        public string strjoning1 { get; set; }
        public string strLeaving1 { get; set; }
        public string strRemarks1 { get; set; }

        public string strNameofComapny2 { get; set; }
        public string strResponsibility2 { get; set; }
        public string strjoning2 { get; set; }
        public string strLeaving2 { get; set; }
        public string strRemarks2 { get; set; }

        public string strNameofComapny3 { get; set; }
        public string strResponsibility3 { get; set; }
        public string strjoning3 { get; set; }
        public string strLeaving3 { get; set; }
        public string strRemarks3 { get; set; }

        public string strtest1 { get; set; }
        public string strExaminationDate1 { get; set; }
        public string strMarks1 { get; set; }

        public string strtest2 { get; set; }
        public string strExaminationDate2 { get; set; }
        public string strMarks2 { get; set; }

        public string strtest3 { get; set; }
        public string strExaminationDate3 { get; set; }
        public string strMarks3 { get; set; }
